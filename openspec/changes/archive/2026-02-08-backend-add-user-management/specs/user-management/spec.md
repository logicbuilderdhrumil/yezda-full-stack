...
The system SHALL provide a list of users with basic search and filter controls.
...
The system SHALL allow admins to create and update user accounts.
...
The system SHALL provide a details endpoint for user accounts.
