...
The system SHALL provide an API to list organizations with search and filters.
...
The system SHALL allow system admins to create and update organizations.
...
The system SHALL provide organization detail data by identifier.
