 ...
 * Postgres persistence for file metadata — implements IFileRepository
 */
import { query } from '../../../../shared/infrastructure/database/index.js';
import type { FileMetadata, FileListOptions, FileListResult } from '../../domain/entities/index.js';
