...
export function registerAuthHandlers(mock: MockAdapter): void {
  ...
  mock.onPost('/api/v1/auth/forgot-password').reply(200, forgotPasswordResponse);

  // POST /api/v1/auth/reset-password
  mock.onPost('/api/v1/auth/reset-password').reply(200, resetPasswordResponse);
  ...
  mock.onPost('/api/v1/auth/verify-totp').reply(200, verifyTotpResponse);
